...
--
-- Host: localhost
-- Generation Time: Feb 03, 2023 at 11:22 AM
...
(1, 'Kata qui retourne !', 'Ce kata est le premier créé lors de ce projet, il est si simple.\n', 'La function doit retourné :', 0, ' ######  ########  \n##    ## ##     ## \n## KATA  ## -SR ## \n ######  ########  \n      ## ##   ##   \n##    ## ##    ##  \n ######  ##     ## ', 'KATA-SR', 'KATA-SR', 'KATA-SR'),
(2, 'C\'est court !', 'La fonction doit retourner 50 si ma data est null ou undefined, sinon elle doit retourner la valeur de data.', 'Vous n\'avez que 100 charactères disponible.', 100, NULL, '50', '15', '15'),
(3, 'A l\'envers !', 'La fonction doit retourner le string data à l\'envers en minuscule.', 'Vous avez que 100 characteres disponible.', 100, 'WildCodeSchool', 'loohcsedocdliw', 'AbcdEfg', 'gfedcba'),
(4, 'Comme la Nintendo !', 'Grace à la fonction nous devons retrouver le nom de domaine cacher dans la data.', 'Vous avez que 100 characteres disponible.', 100, 'WVdOMGRTMXNZVzR1WTI5dA==', 'actu-lan.com', 'WVhOemJ5MXlaWE53WVhkdUxtWnk=', 'asso-respawn.fr'),
